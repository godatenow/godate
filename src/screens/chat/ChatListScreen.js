...
const ChatListScreen = () => {
  ...
  {!loading && (
    ...
    <View style={rtlStyles} accessibilityLabel=t("תוכן נגיש")><Text accessibilityLabel=t("תוכן נגיש")>{t(" t(")}</Text accessibilityLabel=")תוכן נגישt("></View accessibilityLabel=")תוכן נגיש">
  );
};
