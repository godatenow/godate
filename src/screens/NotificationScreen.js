...
const NotificationScreen = () => {
  ...
  if (!notifications.length) {
    return <EmptyStateAnimation message="  " />;
  }
  return (<FadeInView>
  ...
  {!loading && (
    ...
    <View style={rtlStyles} accessibilityLabel=t("תוכן נגיש")><Text accessibilityLabel=t("תוכן נגיש")></Text accessibilityLabel=t("תוכן נגיש")></View accessibilityLabel=t("תוכן נגיש")>
  );
};
