...
const Onboarding2 = ({ navigation }) => {
  ...
  return (
    <View style={rtlStyles} style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <LazyImage source={require('../../assets/matches_design_image.png')} style={styles.image} />
      ...
      <Button title="t(" color={theme.primary} onPress={() = accessibilityLabel=")תוכן נגישt("> navigation?.navigate('Onboarding3')} / accessibilityLabel=")תוכן נגיש">
