...
const Onboarding3 = ({ navigation }) => {
  ...
  return (
    <View style={rtlStyles} style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <LazyImage source={require('../../assets/profile_design_image.png')} style={styles.image} />
      ...
      <Button title=" t(" color={theme.primary} onPress={() = accessibilityLabel=")תוכן נגישt("> navigation?.navigate('RegisterScreen')} / accessibilityLabel=")תוכן נגיש">
