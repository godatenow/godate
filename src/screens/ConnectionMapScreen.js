...
const ConnectionMapScreen = () => {
  return (
    <View style={rtlStyles} style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff', padding: 20 }}>
      <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 10 }} accessibilityLabel=t("תוכן נגיש")>{t(t("ConnectionMapScreen"))}</Text accessibilityLabel=t("תוכן נגיש")>
